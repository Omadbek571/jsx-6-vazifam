    ...
    <div className="base-container flex justify-center mt-5">
      <form onSubmit={handSubmit} className="w-full max-w-96">
        ...
        <div className="flex flex-col gap-5">
          ...
          />
          <select defaultValue="Mashina brendini tanlang*" name="brand" className="select select-accent w-full">
            <option disabled >
          ...
          <select defaultValue="Mashina rangini tanlang*" name="colorCar" className="select select-accent w-full">
            <option disabled >
